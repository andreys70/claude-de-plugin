...
For this orchestrator (enhancement flow): **all four MCPs are required.** Read the skill ref and follow it exactly — toolset inspection only, no MCP calls, deferred authentication.
